...
print('TensorFlow module:')
raw_accuracy('../Gold/Hindi_pipeline_gold_tf.txt','../Pipeline/Hindi_pipeline_test_tf.txt')
CHRF_score('../Gold/Hindi_pipeline_gold_tf.txt','../Pipeline/Hindi_pipeline_test_tf.txt')
print('Pandas module:')
raw_accuracy('../Gold/Hindi_pipeline_gold_pandas.txt','../Pipeline/Hindi_pipeline_test_pandas.txt')
CHRF_score('../Gold/Hindi_pipeline_gold_pandas.txt','../Pipeline/Hindi_pipeline_test_pandas.txt')
print('pytorch module:')
raw_accuracy('../Gold/Hindi_pipeline_gold_pytorch.txt','../Pipeline/Hindi_pipeline_test_pytorch.txt')
CHRF_score('../Gold/Hindi_pipeline_gold_pytorch.txt','../Pipeline/Hindi_pipeline_test_pytorch.txt')
print('Total (all modules):')
